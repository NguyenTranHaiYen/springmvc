...
<body>
	...
	<div class="container">
		...
		<h1 style="margin-top: 30px">Phiếu Nhập</h1>
			<div class="row">	
				<a class="btn btn-success col-6" href="chitietphieunhap.html"><i class="fa fa-plus-circle"></i>Thêm Sản Phẩm Cho Phiếu Nhập</a>
				<a class="btn btn-success col-4" href="savePhieuNhap.html"><i class="fa fa-save"></i>Lưu Phiếu Nhập</a>
			</div>
		</div>

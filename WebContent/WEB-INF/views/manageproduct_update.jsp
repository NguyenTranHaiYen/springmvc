	...
	<div class="container">
		...
		<div class="row">
			<div class="col col-xs-12">
				<image width="1024px" height="379px"
					src="images/KV-B2S-8-digital-02-Copy-1024x379.jpg" />
			</div>
		...
		<fieldset>
			<form:form action="insert.html" modelAttribute="product"
				...
				<div class="form-group">
					<div class="col-sm-9">
						<form:input path="proId" class="form-control" readonly="true"
							style="display:none" />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-9">
						<form:input path="quantity" class="form-control" readonly="true"
							style="display:none"/>
					</div>
				</div>
